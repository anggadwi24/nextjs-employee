...
const Add = (props: Props) => {
    const breadcrumb = [{ name: "User", url: "/users" }, { name: "Add", url: "/users/add" }];
            ...
            <form onSubmit={submitHandle}>
                <div className="grid gap-6 mb-6 md:grid-cols-2 mx-4">
                    ...
                    <div>
                        ...
                        <Input disabled={loading ? true : false} type="text" placeholder={"Insert email"} className={error && error.name ? `bg-red-50 border-red-500 text-red-800` : ``} value={email} onChange={(e) => setEmail(e.target.value)} />
